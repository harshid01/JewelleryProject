    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <a href="collections.php"><button class="main-btn">Explore Collection's<i class="fas fa-solid fa-basket-shopping ps-3"></i></button></a>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12 text-sec">
              ...
              <a href="collections.php"> <button class="main-btn mt-4">Explore Collection</button></a>
            </div>
          </div>
        </div>
                ...
                <div class="pt-3">
                  ...
                  <span>10GM To 1KG</span>
                      <div class="product-btns">
                                  <a href="collections.php">  <button class="view-btn">
                                        Explore Our Collection's
                                    </button> </a>
                                </div>
                </div>
              </div>
        ...
        <div class="container book-food-text">
          <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-12 mt-lg-0 mt-4">
             <a href="collections.php"><button class="main-btn">Explore Our Collection</button></a>
            </div>
          </div>
        </div>
      </div>
