...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <a class="header-link" style="font-size: 2rem; font-family: Sofia, sans-serif;">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control" name="phone" placeholder="Phone (WhatsApp preferred) *" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-map-marker-alt"></i></span>
                                    <input type="text" class="form-control" name="city" placeholder="Business Location (City) *" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-box"></i></span>
                                    <input type="text" class="form-control" name="monthly_volume" placeholder="Estimated Monthly Volume">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fab fa-instagram"></i></span>
                                    <input type="text" class="form-control" name="social_media" placeholder="Instagram/Facebook Page">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fas fa-pen"></i></span>
                                    <textarea class="form-control" rows="3" name="business_goals" placeholder="Share your business goals with us *" required></textarea>
                                </div>
                            </div>
...
$("#wholesaleForm").submit(function(e){

    e.preventDefault();

    $.ajax({

        url:"insert-wholesale.php",
