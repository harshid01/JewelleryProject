...
session_start();
?>
<?php include 'index-master/master-top.php'; ?>
<?php include 'index-master/header.php'; ?>

<!-- Section 1: Home Banner -->
<section id="home" class="top-banner">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1>Elegant & Timeless Jewellery for Every Occasion</h1>
                <p>
                    Discover our exquisite collection of fine jewellery designed to add sparkle to your every moment. From handcrafted rings to statement necklaces, each piece tells a story of elegance and beauty.
                </p>

                <a href="Indexactivity/login.php"><button class="main-btn">Login<i class="fas fa-solid fa-basket-shopping ps-3"></i></button></a>
                <a href="Indexactivity/registraton.php"><button class="white-btn ms-lg-4 mt-lg-0 mt-4">Regirstration<i class="fas fa-angle-right ps-3"></i></button></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-12 text-sec">
              ...
              <!-- explore more button in add god blesses products ???-->
              <a href="Indexactivity/login.php"> <button class="main-btn mt-4">Explore Collection</button></a>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row pt-5">
            <div class="col-lg-4 col-md-6 mb-lg-0">
              <div class="card">
                <img src="images/img/mens (1).jpg" class="img-fluid">
                <div class="pt-3">
                  <h4>MEN'S COLLECTION</h4>
                  <p>Royal Radiance</p>
                  <span>10GM To 1KG</span>
                  <a href="Indexactivity/login.php"><button class="mt-4 main-btn">Explore Our Collection's</button></a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-lg-0">
              <div class="card">
                <img src="images/img/girls (1).jpg" class="img-fluid">
                <div class="pt-3">
                  <h4>WOMENE'S COLLECTION</h4>
                  <p>The Maharani Collection</p>
                  <span>10GM To 1KG</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-lg-0">
              <div class="card">
                <img src="images/img/kids (1).jpg" class="img-fluid">
                <div class="pt-3">
                  <h4>KIDS COLLECTION</h4>
                  <p>Giggles & Gold -Little Sparkles</p>
                  <span>10GM To 500GM</span>
                 <!-- <a href="api/kids.html"><button class="mt-4 main-btn">Kids Collection</button></a> -->
                </div>
              </div>
            </div>
        ...
        <div class="container book-food-text">
          <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-12 mt-lg-0 mt-4">
             <a href="Indexactivity/login.php"><button class="main-btn">Gemstone Collection</button></a>
            </div>
          </div>
        </div>
      </div>
